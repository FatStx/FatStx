            ...
            <Grid container spacing={2} sx={{ width: '100%' }}>
              <Grid size={6}>
                <Autocomplete
                  ...
                  renderInput={(params) => <TextField {...params} label="Include Labels" />}
                />
              </Grid>
              <Grid size={6}>
                <Autocomplete
                  ...
                  renderInput={(params) => <TextField {...params} label="Exclude Labels" />}
                />
              </Grid>
            </Grid>
          </Paper>
        ...
        >
          <Paper sx={{ p: 2, display: 'flex', flexDirection: 'column' }}>
            ...
            <Table size="small">
              ...
              <TableBody>
                {futureBlocks
                  .filter((row) => row.tags.filter((tag) => includedTags.includes(tag)).length > 0)
                  .filter(
                  ...
                  .map((row, key) => (
                    <TableRow key={key}>
                      ...
                      <TableCell>
                        <Typography color="common.grey" sx={{ fontWeight: 500 }}>
                          {row.when.delta}
                        </Typography>
                        <Typography
                          color="common.grey"
