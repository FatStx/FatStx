export class Token {
    static tokens = [
      ...
      {symbol:'DIKOLPSTX_USDA',apiSymbol:'',contract:'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-swap-token-wstx-usda::wstx-usda',conversionFactor:1000000,amountDecimals: 3,priceDecimals: 2},
      {symbol:'DIKOLPSTX_XBTC',apiSymbol:'',contract:'SP2C2YFP12AJZB4MABJBAJ55XECVS7E4PMMZ89YZR.arkadiko-swap-token-wstx-xbtc::wstx-xbtc',conversionFactor:1000000,amountDecimals: 3,priceDecimals: 2}
    ];
}
